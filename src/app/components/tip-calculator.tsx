...
export default function TipCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-teal-800 dark:bg-gray-900">
      {/* Center the tip calculator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        <CardHeader>
          {/* Header with title and description */}
          <center><u><CardTitle>Tip Calculator</CardTitle></u></center>
          <br></br><CardDescription className="text-gray-800 text-sm font-medium">
  Enter the bill amount and tip percentage to calculate the tip and total.
      ...
      <br></br><div className="flex flex-col items-center justify-center -screen bg-gray-100">
